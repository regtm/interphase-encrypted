...
[_FUNCTION] = { /* Function Layer, primary alternative layer featuring numpad on left hand,
	...
	{KC_ESC,  XXXXXXX, KC_NLCK, KC_P7,   KC_P8,   KC_P9,   KC_PSLS,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F1,   KC_F2,   KC_F3 },
 	{KC_VOLD, KC_VOLU, XXXXXXX, KC_P4,   KC_P5,   KC_P6,   KC_PAST,   KC_PGUP, KC_END,  KC_UP,   KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX },
 	{XXXXXXX, XXXXXXX, XXXXXXX, KC_P1,   KC_P2,   KC_P3,   KC_PMNS,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, XXXXXXX },
 	{XXXXXXX, XXXXXXX, XXXXXXX, KC_P0,   KC_PDOT, KC_PENT, KC_PPLS,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX },
